...
ENABLE_INTERNAL_REVIEW_AUTOMATION=false
...
| `ENABLE_INTERNAL_REVIEW_AUTOMATION` | `false` | Allows the n8n Assistant GitHub App to recommend and assign reviewers. |
...
Upstream internal E2E infrastructure, private metrics reporting, Slack notifications, GitHub App reviewer automation, private image publishing, and credential-backed AI evaluations are intentionally excluded.
...
CI_MODE=fork-safe internal_review_automation=false component=recommendations
CI_MODE=fork-safe internal_review_automation=false component=assignment
```
